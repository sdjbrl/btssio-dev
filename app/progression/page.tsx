  ...
  return (
    <div className="min-h-screen bg-[#0F172A] text-white">
      <div className="max-w-3xl mx-auto px-4 py-16">
        <div className="mb-10">
          <h1 className="text-4xl font-bold font-mono mb-2">Ma Progression</h1>
          ...
          {modules.map((mod) => {
            ...
            return (
              <Link
                key={mod.key}
                href={mod.href}
                className="flex items-center gap-4 p-4 bg-[#1E293B] border border-[#334155] hover:border-[#475569] rounded-xl transition-all group"
              >
                {done ? (
